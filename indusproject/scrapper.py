...
def collect_non_zero_po_numbers(page, max_pages=8):
    po_list = []
    current_page = 1
...
def collect_rev0_po_numbers(page, max_pages=4):
    po_list = []
...
def find_po_in_pages(page, po_number, max_pages=8, retries=3):
    attempt = 0
    while attempt < retries:
        current_page = 1
        while current_page <= max_pages:
