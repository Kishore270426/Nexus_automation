...
from .views import get_po_data, bulk_scrape, update_erp_password, update_cron_time, scheduler_status
...
urlpatterns = [
    ...
    path('api/scheduler-status/', scheduler_status, name='scheduler_status'),
]
